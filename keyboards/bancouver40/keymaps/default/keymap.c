...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_ortho_4x10(
    ...
    KC_NO, KC_NO, KC_TAB, NUM_SPC, SYM_ESC, FUN_ENT, NAV_BSP, KC_DELETE, KC_VOLD, KC_VOLU
    ),
  ...
  [_QWERTY] = LAYOUT_ortho_4x10(
    ...
    KC_LGUI, KC_NO, KC_TAB, NUM_SPC, SYM_ESC, FUN_ENT, NAV_BSP, KC_DELETE, KC_VOLD, KC_VOLU
    ),
