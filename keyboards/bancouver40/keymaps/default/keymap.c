...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_ortho_4x10(
    ...
    GUI_A,   ALT_R,  SFT_S,  CTR_T,   KC_G,    KC_M,    CTR_N,   SFT_E,   ALT_I,   GUI_O,
  ...
  [_QWERTY] = LAYOUT_ortho_4x10(
    ...
    GUI_A,   ALT_S,  SFT_D,  CTR_F,   KC_G,    KC_H,    CTR_J,   SFT_K,   ALT_L,   GUI_SCLN,
  ...
  [_NAVIGATION] = LAYOUT_ortho_4x10(
    KC_PGUP, KC_PGDN, KC_HOME, KC_END,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
